  ...
  return (
    <>
      <div className="text-center md:ml-80 pb-2 pt-8">
        <h1 className='inline-block hover:text-5xl hover:mb-0 text-cyan-500 hover:text-white text-3xl md:text-7xl'>Dashboard</h1>
      </div>

      <div className="p-8 min-h-screen">
        <div className="flex flex-col md:flex-row justify-between">
          <div className="md:ml-80 pt-20 w-full md:w-2/6 mb-8 md:mb-0 md:mr-8 bg-white shadow shadow-xl shadow-cyan-500 p-6 rounded-lg">
          ...
          <div className="w-full md:w-4/6 md:mr-10 bg-white text-black pt-10 pb-20 pl-5 rounded-lg shadow shadow-xl shadow-cyan-500">
